import pandas as pd
from factortest.Infras.DataFetcher import ExcelDataFetcher
...
class Contract:
    def __init__(
            self, commodity, first_listed_date, month_list, init_margin_rate, contract_unit, open_comm, close_comm
    ):
